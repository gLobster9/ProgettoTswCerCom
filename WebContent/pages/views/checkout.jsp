					...
					<div class="riepilogo-ordine">
						<table>
							...
							<tr class="prodotti-carrello" id="prodotti-carrello">
								...
								<td class="td"><img class="immagine-prodotto" src="${pageContext.request.contextPath}/api/GetImage?nome=<%=prodottoOrdine.getProdottoBean().getGrafica()%>" alt="<%=prodottoOrdine.getProdottoBean().getNome()%>"></td>
